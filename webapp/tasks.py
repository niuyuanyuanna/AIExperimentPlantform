...
EMAIL_URL = 'http://127.0.0.1:8888/web/activate'
Reset_Pass = 'http://127.0.0.1:8888/web/resetpass'
...
def sendmail(mail):
    ...
    send_mail(u"SimpletourDevops用户激活邮件",emailmessages,'13701112344@139.com',[mail['to'],],fail_silently=True)
    print "---------------------------------"
    return mail['to']
...
def resetpass(mail):
    ...
    send_mail(u"SimpletourDevops重置密码",emailmessages,'13701112344@139.com',[mail['to'],],fail_silently=True)
    print "---------------------------------"
    return mail['to']
