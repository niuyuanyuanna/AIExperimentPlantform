...
@login_required()
@permission_required('dockermanager.docker_index_view',raise_exception=True)
...
@login_required()
@permission_required('dockermanager.add_dockerhost',raise_exception=True)
...
@login_required()
@permission_required('dockermanager.delete_dockerimage',raise_exception=True)
...
@login_required()
@permission_required('dockermanager.delete_dockerhost',raise_exception=True)
...
@login_required()
@permission_required('dockermanager.change_dockerhost',raise_exception=True)
...
@login_required()
@permission_required('dockermanager.delete_dockercontainerinfo',raise_exception=True)
